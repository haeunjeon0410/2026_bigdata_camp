...
잔치국수,면류,"국수, 다시다, 대파, 간장, 계란",20,어려움,1. 다시다로 육수를 끓인다. | 2. 국수를 따로 삶아 찬물에 헹군다. | 3. 그릇에 면을 담고 뜨거운 육수를 붓는다. | 4. 지단 and 대파를 고명으로 올려 완성한다.,🍜,깔끔하고 시원한 멸치 육수에 삶은 소면과 고명을 가득 얹어 든든하고 따뜻하게 속을 달래줍니다.,"['🍲', '🍜', '🥚', '🍽️']"
...
export const ALTERNATIVE_RECIPES = [
  {
    ...
    totalPrice: 8600,
    substituteTips: [], // 편의점 조합 레시피에도 동일한 필드명 적용
  },
  {
    id: "alt2",
    name: "불닭치즈삼김밥",
